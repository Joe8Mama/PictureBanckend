...
public class PictureEditEventProducer {
     ...
     * @param pictureId
     */
    public void publish(PictureEditRequestMessage pictureEditRequestMessage, WebSocketSession session, User user, Long pictureId) {
        ...
        // 发布事件
        log.info("图片编辑事件：A {}", pictureEditEvent);
